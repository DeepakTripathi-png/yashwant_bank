...
<div id="banner-area">
    <img style="padding-top: 4%;"   src="{{url('front/images/banner/pigmi.jpg')}}" width="100%" alt="" />
    <div class="parallax-overlay"></div>
    <div class="banner-title-content">
        <div class="text-center">
            <h2>@lang('terms.heading')</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">@lang('terms.home')</a></li>
                    <li class="breadcrumb-item text-white" aria-current="page">@lang('terms.heading')</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 heading text-center">
                <h1 class="title-border">@lang('terms.heading')</h1>
            </div>
            <div class="col-md-2 heading text-center">
            </div>
        </div>
