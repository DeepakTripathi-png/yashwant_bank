...
<div id="banner-area">
    <img style="padding-top: 4%;" src="{{!empty($banner->banner_image_path)?url('/').Storage::url($banner->banner_image_path):asset('front/images/banner/neft.jpg')}}" width="100%" alt="" />
    ...
    <div class="container">
        ...
        <div class="row about-wrapper-top">
            <div class=" ">
                <div class="row">
                    <div class="col-md-4">
                        <img style="height:200px;width:400px;"  class="img-fluid"  src="{{!empty($service->service_image_path)?url('/').Storage::url($service->service_image_path):asset('front/images/facility/neft2.jpg')}}" alt="">
                    </div>
                    <div class="col-md-7">
