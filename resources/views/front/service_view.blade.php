...
<div id="banner-area" class="hide-on-mobile">
    <img style="padding-top: 4%;"  src="{{!empty($banner->banner_image_path)?url('/').Storage::url($banner->banner_image_path):asset('front/images/banner/sms_alert.jpg')}}" width="100%" alt="" />
        ...
        <div class="row about-wrapper-top">
            <div class=" ">
                <div class="row">
                    ...
                    @if(!empty($service->service_slug_url=='pigmy-deposit-scheme'))
                    ...
                    <div class="col-md-4">
                        <img style="height:200px;width:400px;"  class="img-fluid" src="{{!empty($service->service_image_path)?url('/').Storage::url($service->service_image_path):asset('front/images/facility/sms_alert.jpg')}}" alt="">
                    </div>
